...
<body>
	...
	<div class="mid-div">
		...
		<br><br>
		<h2 style="font: 25px Lucida Sans Unicode">You have been logged out!</h2>
		...
		<?php
			...
			echo 
			"<div style ='font:22px Lucida Sans Unicode,sans-serif; margin:1px auto; text-align:center'>
				Good-bye, <div style ='color:red'>".$_SESSION["username"]."!</div>
			</div>";
			}
